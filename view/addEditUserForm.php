...
<?php ob_start();?>
    ...
    <div class="mainContent">
            ...
            <?php if(isset($_GET['edit'])):?>
                <h1 id="editUser" class="centerText">Edit User</h1>
            <?php else: ?>
                <h1 id="addUser" class="centerText">Add User</h1>
            <?php endif;?>
            ...
            <form id="addEditUserForm" method="POST" action="index.php" class="createUser">
                ...
                <?php if(!isset($user)):?>
                    ...
                    <div id="button">
                        <button type="button" class="btn" id="genButton" onclick="genPassword()">Generate</button>
                        <button type="button" class="btn" id="copyButton" onclick="copyPassword()">Copy</button>
                    </div>
                ...
                <button type="submit" id="submit" class="greenStyle btn" form="addEditUserForm">Submit</button>
            </form>
